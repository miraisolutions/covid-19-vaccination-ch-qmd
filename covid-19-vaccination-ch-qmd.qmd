...
# saveRDS(last_timeline_weeks, "www/bag_data/last_timeline_weeks.rds") 
...
saveRDS(data1, "www/bag_data/data1.rds") 
...
data1 <- readRDS("www/bag_data/data1.rds") 
...
saveRDS(data2, "www/bag_data/data2.rds") 
...
#| context: server 
data2 <- readRDS("www/bag_data/data2.rds") 
# last_timeline_weeks <- readRDS("www/bag_data/last_timeline_weeks.rds") 
...
This page article aims also at showing how an **R Markdown** file can be deployed to **shinyapps.io** to be a live page. For details on the architecture of the **covid19vaccinationch** R package that supports this deployment and its installation see the [README](https://github.com/miraisolutions/covid19-vaccination-ch#readme){target="_blank"} on our public **GitHub** repository or read the related [**news post**](https://mirai-solutions.ch/news/2022/03/08/announce-covid19-vaccination-ch/){target="_blank"} where we described it more in details.
