...
- tests can be placed in a second `Tests.qmd` file to be rendered also in CI (Render Quarto Project step)
- GitHub actions to be updated removing package check
