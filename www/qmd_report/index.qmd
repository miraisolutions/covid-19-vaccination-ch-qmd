...
if (params$fetch_latest_data) {
  ...
  # read from RDS
  DATA <- readRDS(file.path(data_path_qmd(), "DATA.rds"))
}
...
```{r}
#| label = "ageclasses-pandemic-month-calc",
#| warning = FALSE,
#| include = FALSE,
#| cache = TRUE
...
```{r}
#| label = "ageclasses-pandemic-month",
#| warning = FALSE,
#| out.width = "100%",
#| fig.asp = 0.5,
#| dpi = 150
...
```{r}
#| label = "ageclasses-pandemic-month-100k",
#| out.width = "100%",
#| fig.asp = 0.5,
#| dpi = 150
...
```{r}
#| label = "ageclasses-vacc-perc-plot",
#| warning = FALSE,
#| out.width = "100%",
#| fig.asp = 0.5,
#| dpi = 150
...
```{r}
#| label = "ageclasses-tot-confirmed",
#| warning = FALSE,
#| out.width = "100%"
...
```{r }
#| label = "ageclasses-vacc-unvac-dataplot",
#| warning = FALSE,
#| cache = TRUE
...
```{r}
#| label = "ageclasses-vacc-unvac-tab-pop-infect",
#| warning = FALSE,
#| out.width = "100%"
# DataTab = DataPlot %>%
#   rename(Status = vaccination_status) %>%
...
```{r}
#| label = "ageclasses-vacc-unvac-tab4-calc",
#| echo = FALSE,
#| warning = FALSE,
#| warning = FALSE,
#| cache = TRUE
...
```{r}
#| label = "ageclasses-vacc-unvac-tab4-tab",
#| warning = FALSE,
#| out.width = "100%"
DataTabScale %>%
  mutate(value = formatC(round(value), format = "f", big.mark = "'", digits = 0)) %>%
...
```{r}
#| label = "ageclasses-vacc-unvac-scale100k-plot",
#| warning = FALSE,
#| out.width = "100%",
#| fig.asp = 0.5,
#| dpi = 150
...
```{r}
#| label = "ageclasses-vacc-unvac-scale100k-graph",
#| warning = FALSE,
#| out.width = "100%",
#| fig.asp = 0.5,
#| dpi = 150
...
```{r}
#| label = "ageclasses-vacc-unvac-scale100k-tab",
#| warning = FALSE,
#| out.width = "100%"
...
```{r}
#| label = "ageclasses-cases-scenarios-100k",
#| out.width = "100%",
#| fig.asp = 0.5,
#| dpi = 150
...
```{r}
#| label = "ageclasses-cases-scenarios",
#| out.width = "100%",
#| fig.asp = 0.5,
#| dpi = 150,
#| position = "absolute"
...
```{r}
#| label = "ageclasses-cases-scenarios-tab",
#| warning = FALSE,
#| echo = FALSE,
#| include = TRUE,
#| out.width = "100%"
...
```{r}
#| label = "ageclasses-timeline-calc",
#| context = "data",
#| echo = FALSE,
#| cache = TRUE
...
```{r}
#| label = "ageclasses-pandemic-hosp-deaths-timeline_100k-graph",
#| warning = FALSE,
#| out.width = "100%",
#| fig.asp = 0.85
...
```{r}
#| label = "ageclasses-pandemic-hosp-deaths-timeline_100k-server",
#| context = "server",
#| warning = FALSE,
#| out.width = "100%",
#| fig.asp = 0.85,
...
```{r}
#| label = "ageclasses-pandemic-hosp-deaths-timeline_ratio",
#| context = "data",
#| warning = FALSE,
#| cache = TRUE
...
```{r}
#| label = "ageclasses-pandemic-hosp-deaths-timeline_ratio-graph",
#| warning = FALSE,
#| out.width = "100%",
#| fig.asp = 0.85,
#| dpi = 150
...
```{r}
#| label = "ageclasses-pandemic-hosp-deaths-timeline_ratio-server",
#| context = "server",
#| warning = FALSE,
#| out.width = "100%",
#| fig.asp = 0.85,
